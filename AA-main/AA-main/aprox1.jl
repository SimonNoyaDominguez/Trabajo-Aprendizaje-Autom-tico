...
bool_imgs = imageToBoolM.(imgs);

test_bool_imgs = imageToBoolM.(test_imgs);
#######################################################################################
...
println("============================================================")
println("ANN-1:")
ANN_results1 = modelCrossValidation(:ANN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

topology2 = Int[3, 5];
modelHyperparameters["topology"] = topology2;
println("============================================================")
println("ANN-2:")
ANN_results2 = modelCrossValidation(:ANN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

topology3 = Int[1, 2];
modelHyperparameters["topology"] = topology3;
println("============================================================")
println("ANN-3:")
ANN_results3 = modelCrossValidation(:ANN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

topology4 = Int[4];
modelHyperparameters["topology"] = topology4;
println("============================================================")
println("ANN-4:")
ANN_results4 = modelCrossValidation(:ANN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

topology5 = Int[5, 3];
modelHyperparameters["topology"] = topology5;
println("============================================================")
println("ANN-5:")
ANN_results5 = modelCrossValidation(:ANN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

topology6 = Int[2, 2];
modelHyperparameters["topology"] = topology6;
println("============================================================")
println("ANN-6:")
ANN_results6 = modelCrossValidation(:ANN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

topology7 = Int[6];
modelHyperparameters["topology"] = topology7;
println("============================================================")
println("ANN-7:")
ANN_results7 = modelCrossValidation(:ANN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

topology8 = Int[4, 1];
modelHyperparameters["topology"] = topology8;
println("============================================================")
println("ANN-8:")
ANN_results8 = modelCrossValidation(:ANN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);
...
println("============================================================")
println("SVM-1:")
SVM_results1 = modelCrossValidation(:SVM, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);
...
println("============================================================")
println("SVM-2:")
SVM_results2 = modelCrossValidation(:SVM, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);
...
println("============================================================")
println("SVM-3:")
SVM_results3 = modelCrossValidation(:SVM, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);
...
println("============================================================")
println("SVM-4:")
SVM_results4 = modelCrossValidation(:SVM, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);
...
println("============================================================")
println("SVM-5:")
SVM_results5 = modelCrossValidation(:SVM, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);
...
println("============================================================")
println("SVM-6:")
SVM_results6 = modelCrossValidation(:SVM, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);
...
println("============================================================")
println("SVM-7:")
SVM_results7 = modelCrossValidation(:SVM, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);
...
println("============================================================")
println("SVM-8:")
SVM_results8 = modelCrossValidation(:SVM, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);
...
DecisionTree_results1 = modelCrossValidation(:DecisionTree, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

max_depth2 = 3;
modelHyperparameters["max_depth"] = max_depth2;
println("============================================================")
println("DecisionTree-2:")
DecisionTree_results2 = modelCrossValidation(:DecisionTree, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

max_depth3 = 5;
modelHyperparameters["max_depth"] = max_depth3;
println("============================================================")
println("DecisionTree-3:")
DecisionTree_results3 = modelCrossValidation(:DecisionTree, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

max_depth4 = 10;
modelHyperparameters["max_depth"] = max_depth4;
println("============================================================")
println("DecisionTree-4:")
DecisionTree_results4 = modelCrossValidation(:DecisionTree, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

max_depth5 = 8;
modelHyperparameters["max_depth"] = max_depth5;
println("============================================================")
println("DecisionTree-5:")
DecisionTree_results5 = modelCrossValidation(:DecisionTree, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

max_depth6 = 15;
modelHyperparameters["max_depth"] = max_depth6;
println("============================================================")
println("DecisionTree-6:")
DecisionTree_results6 = modelCrossValidation(:DecisionTree, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);
...
println("============================================================")
println("kNN-1:")
kNN_results1 = modelCrossValidation(:kNN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

n_neighbors2 = 2;
modelHyperparameters["n_neighbors"] = n_neighbors2;
println("============================================================")
println("kNN-2:")
kNN_results2 = modelCrossValidation(:kNN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

n_neighbors3 = 5;
modelHyperparameters["n_neighbors"] = n_neighbors3;
println("============================================================")
println("kNN-3:")
kNN_results3 = modelCrossValidation(:kNN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

n_neighbors4 = 8;
modelHyperparameters["n_neighbors"] = n_neighbors4;
println("============================================================")
println("kNN-4:")
kNN_results4 = modelCrossValidation(:kNN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

n_neighbors5 = 10;
modelHyperparameters["n_neighbors"] = n_neighbors5;
println("============================================================")
println("kNN-5:")
kNN_results5 = modelCrossValidation(:kNN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);

n_neighbors6 = 7;
modelHyperparameters["n_neighbors"] = n_neighbors6;
println("============================================================")
println("kNN-6:")
kNN_results6 = modelCrossValidation(:kNN, modelHyperparameters, inputs[:,1:1], targets, crossValidationIndices);
...
model = fit!(model, inputs[:,1:1], targets);

testOutputs = predict(model, test_inputs[:,1:1]);
...
#######################################################################################
# Modelo ANN 7
ann, = trainClassANN(topology7, (inputs[:,1:1], oneHotEncoding(targets)),
                    testDataset = (test_inputs[:,1:1], oneHotEncoding(test_targets));
                    maxEpochs=maxEpochs, learningRate=learningRate);

testOutputs = collect(ann(test_inputs[:,1:1]')')[:];
